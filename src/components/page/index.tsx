  ...
  return (
    <div className="sticky top-0 h-screen w-screen contain-paint overflow-hidden">
      <div className="absolute left-0 right-0 top-0 z-20 w-full">
        <div className="section-padding grid-gap sticky top-0 flex h-screen grid-cols-12 flex-col justify-center gap-y-fluid-sm md:grid md:place-items-center md:items-center px-5">
